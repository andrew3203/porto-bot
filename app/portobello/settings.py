"""
Django settings for portobello project.
...
WSGI_APPLICATION = 'portobello.wsgi.application'
...
MSG_PRIMARY_NAMES = [
    ...
    ('sochi_turnover', 'Сочи Оборот')
]

SOCHI_TURNOVER_LINK =  os.environ.get("SOCHI_TURNOVER_LINK")
